...
to phele humko es puri applciation ke docker image banna padega and then us image ko hum docker hub par push karenge and then us image ko hum heroku par deploy karenge. aapka jo bhi server par hosted hai humko bas us server par jake is image ko pull karna hai and then run karna hai.
